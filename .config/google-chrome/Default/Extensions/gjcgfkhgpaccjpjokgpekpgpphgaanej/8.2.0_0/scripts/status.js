...
<table border="0" style="border: 0; margin: 0; padding: 0; width: 100%;">
    ...
    <tr>
        <td>
            <a href="https://vodextended.com/hbo?utm_source=chrome_extension&utm_medium=netflix_extended&utm_campaign=gui_1" target="_blank" style="font-size:12px;color:#00B642;text-decoration:none"><span style="font-weight:bold;color:#B66D00">NEW!</span> Check Extended for HBO Max - <span style="font-weight:bold;">vodextended.com/hbo</span></a>
